# AI Security v1 (static)

Machine-readable security posture for LLMs and reviewers:

- `claim-maturity.json` — canonical WIRED / AUTOMATED_TESTED / E2E / BACKLOG per control
- `attack-model.json` — threats and claim maturity per attack
