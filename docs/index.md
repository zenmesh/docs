...
| **Anyone checking what we do NOT claim** | [Non-Claims../ai/evidence-v1-supersession.md#non-claims) — explicit scope boundaries |
...
| [Non-Claims../ai/evidence-v1-supersession.md#non-claims) | What Zen Mesh does not certify or guarantee |
| [AI Agents](ai/overview) | AI overview, evidence schema../ai/evidence-v1-supersession.md#non-claims, machine-readable manifests |
