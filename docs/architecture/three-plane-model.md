...
- [Capability manifest](ai/evidence-v1-supersession.md) — proof_status and evidence scope per capability
- [Non-claims](ai/evidence-v1-supersession.md) — what Zen Mesh does **not** claim
