    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        redirects: [
          ...
          {from: '/concepts/planes', to: '/docs/concepts/planes'},
          {from: '/install/choose-runtime-path', to: '/docs/install/choose-runtime-path'},
          {from: '/install/edge-plane', to: '/docs/install/edge-plane'},
          {from: '/install/kubernetes-edge-plane', to: '/docs/install/kubernetes-edge-plane'},
          {from: '/install/edge-lite', to: '/docs/install/edge-lite'},
          {from: '/install/data-plane', to: '/docs/install/data-plane'},
          {from: '/guides/cluster-enrollment', to: '/docs/install/kubernetes-edge-plane'},
        ],
