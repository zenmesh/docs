...
export const server1 = new ServerConfiguration<{  }>("https://api.zen-mesh.io/v1", {  })
export const server2 = new ServerConfiguration<{  }>("https://staging.api.zen-mesh.io/v1", {  })
export const server3 = new ServerConfiguration<{  }>("https://staging.api.zen-mesh.io/v1", {  })
