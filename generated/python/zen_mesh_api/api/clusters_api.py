...
class ClustersApi:
    ...
    def _create_cluster_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/tenants/{tenant_id}/clusters',
    ...
    def get_cluster(
        self,
        tenant_id: StrictStr,
        cluster_id: Annotated[StrictStr, Field(description="The cluster (plane) ID.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param tenant_id: (required)
        :type tenant_id: str
        :param cluster_id: The cluster (plane) ID. (required)
        :type cluster_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _get_cluster_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenant_id}/clusters/{cluster_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_clusters_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListClusters200Response]:
        """Get tenant planes
